  ...
  return (
    <div ref={containerRef} className="relative min-w-0 flex-1 sm:min-w-[220px]">
      ...
      <input
        ...
        autoComplete="off"
        className="mt-1 w-full rounded-xl border border-stone-200 dark:border-stone-700 px-3.5 py-2.5 text-sm outline-none transition focus:border-orange-400 focus:ring-2 focus:ring-orange-400/20"
        style={{ background: "var(--bg-base)", color: "inherit" }}
      />
      {loading ? (
